...
allstatssorted %>%
  ...
  tab_source_note(
    source_note = md("**By:** Natalie Frick  |  **Source:** Basketball-Reference.com")
  )
```
...
ggplot() +
  ...
  labs(title="The 2008 team proves they earned their Championship title.", subtitle="2011 and 2003 teams stay consistent with the championship winning teams." , x="Total Wins", y="Win Percentage",caption="Source: Basketball-Reference.com | By Natalie Frick") +
  theme_minimal() +
  theme(
...
labs(title="2022 season is ranked 10th out of the last 20 seasons.",
     subtitle="The 2011 and 2002 seasons rank higher than the 2022 season in both shooting percentage and SRS", x="", y="Simple Rating System", caption="Source: Basketball-Reference.com | By Natalie Frick") +
  theme_minimal() +
  theme(
...
The 2008 team comes out on top once again and proves they deserved their title. The 2022 team is trailing by a lot. They are ranked 10th while the 2002 and 2011 teams are ranked 5th and 6th. Every chart and graph proves that the 2022 team was a little above average compared to the last 22 seasons and the 2008 team was consistently the best. 
...
The code for this post can be found [here](https://github.com/nataliefrick6/lastproject1/blob/main/Project2Notebook.Rmd)